...
/*****
I've commented all this out so that it doesn't interfere with our version of the teleport script
I was getting errors of some things already having a defifintion in public. So I commented it all out
to be safe.
*****/
